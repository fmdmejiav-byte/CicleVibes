<x-guest-layout>
    <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl shadow-emerald-900/10 ring-1 ring-emerald-900/5 p-8 sm:p-10">
        ...
        <p class="mt-1.5 text-sm text-gray-500">Únete a la comunidad y empieza a explorar nuevas rutas.</p>
        ...
        @if ($errors->any())
            <div class="mt-6 flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 p-3.5 text-sm text-red-700 animate-fade-in">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-red-600/90">Por favor corrige los errores marcados para continuar.</p>
                </div>
            </div>
        @endif
            ...
            <div>
                ...
                <div class="relative mt-1.5">
                    ...
                    <input
                        ...
                        class="block w-full rounded-lg border-gray-300 bg-gray-50 pl-11 pr-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 shadow-sm transition focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/30 @error('apellido') border-red-300 @enderror"
                    >
                </div>
                @error('apellido')
                    <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
            ...
            <div>
                ...
                <div class="relative mt-1.5">
                    ...
                    <input
                        ...
                        :class="{ 'border-red-300': $refs.pwLive && $refs.pwLive.value && $refs.pwLive.value.length < 8 }"
                    >
            ...
            <div>
                ...
                <div class="relative mt-1.5">
                    ...
                    <input
                        ...
                        class="block w-full rounded-lg border-gray-300 bg-gray-50 pl-11 pr-11 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 shadow-sm transition focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/30 @error('password') border-red-300 @enderror"
                    >
                    <button type="button" @click="showConfirm = !showConfirm" class="absolute inset-y-0 right-0 flex items-center pr-3.5 text-gray-400 hover:text-gray-600" :aria-label="showConfirm ? 'Ocultar contraseña' : 'Mostrar contraseña'">
